...
import com.kaua.devkit.platform.application.usecases.users.create.CreateUserInput;
...
import com.kaua.devkit.platform.application.usecases.users.retrive.get.GetUserByIdOutput;
