...
import com.kaua.devkit.platform.application.usecases.auth.code.create.CreateAuthorizationCodeInput;
import com.kaua.devkit.platform.application.usecases.auth.code.create.CreateAuthorizationCodeUseCase;
import com.kaua.devkit.platform.application.usecases.auth.token.create.AuthorizationCodeGrantInput;
import com.kaua.devkit.platform.application.usecases.auth.token.create.ClientSecretGrantInput;
import com.kaua.devkit.platform.application.usecases.auth.token.create.CreateAuthorizationTokenUseCase;
import com.kaua.devkit.platform.application.usecases.auth.token.create.RefreshTokenGrantInput;
...
import com.kaua.devkit.platform.infrastructure.oauth.code.req.CreateAuthorizationCodeRequest;
import com.kaua.devkit.platform.infrastructure.oauth.code.res.CreateAuthorizationCodeResponse;
import com.kaua.devkit.platform.infrastructure.rest.AuthorizeAPI;
